...
class CardsScreen extends StatelessWidget {
  static const String name = 'card_sceeen';
...
class _CardView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    //cuando hay mas contenido hace un sroll para mostrar toda la data
    return SingleChildScrollView(
      child: Column(
        children: [
          //mapear y iterar la data
          ...card.map(
            (card) =>
...
class _CardType4 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final colors = Theme.of(context).colorScheme;
    return Card(
      //evita que los hijos salgan de su padre
      clipBehavior: Clip.hardEdge,
      elevation: elevation,
      child: Column(children: [
        Image.network('https://picsum.photos/id/${elevation.toInt()}/600/350',
            height: 350,
            //forma de mostrar. para que se adapte al espacio
            fit: BoxFit.cover),
        Align(
            alignment: Alignment.topRight,
            child: Container(
